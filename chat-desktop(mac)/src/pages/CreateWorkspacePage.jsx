...
const FEATURES = [
  {
    ...
    desc: "Organised, searchable conversations",
  },
  {
    icon: Users,
    color: "#059669",
    ...
    desc: "Invite your whole team, no limits",
  },
  {
    icon: Zap,
    color: "#d97706",
    ...
    desc: "Instant delivery with live presence",
  },
  {
    icon: Shield,
    color: "#7c3aed",
    ...
    desc: "End-to-end encrypted and private",
  },
];
...
const successText = {
  ...
  visible: { opacity: 1, y: 0, transition: { delay: 0.22, duration: 0.3 } },
};
                  ...
                  whileHover={
                    isSubmitting || !name.trim()
                      ...
                      : {
                          y: -2,
                          boxShadow:
                            "0 10px 32px rgba(99,102,241,.5), 0 22px 52px rgba(99,102,241,.25)",
                        }
                  }
                  whileTap={
                    isSubmitting || !name.trim() ? {} : { y: 0, scale: 0.98 }
                  }
                >
                  {isSubmitting ? (
                    <>
