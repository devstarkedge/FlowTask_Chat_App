  ...
  const renderMentions = useLiveMentionRenderer();
        ...
        >
          ...
          {!compact && (
            ...
            >
              ...
              <span
                className="text-[11px] message-timestamp"
                style={{ color: "var(--text-timestamp)" }}
              >
                {time}
              </span>
              {message.isEdited && (
    ...
    return (
      <div
        id={`msg-${message._id}`}
        ref={messageRef}
        className={`relative group chat-message-row ${highlightMessageId === message._id ? "message-highlight" : ""}`}
        style={{
