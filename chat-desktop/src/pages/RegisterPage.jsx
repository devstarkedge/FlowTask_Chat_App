      ...
      >
        ...
        >
          ...
          >
            ...
            <span className="rp-logo-name">TaskChat</span>
          </Link>
      ...
      <div className="rp-layout">
        ...
        >
          ...
          <motion.p variants={fadeUp} className="rp-subheading">
            Join thousands of teams already using TaskChat to communicate and
            collaborate faster.
          </motion.p>
        ...
        >
          ...
          <motion.p variants={fadeLeft} className="rp-aside-sub">
            TaskChat brings real-time messaging, file sharing, and project tools
