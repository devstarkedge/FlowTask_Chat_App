...
import { Plus, Settings, HelpCircle, MoreHorizontal } from 'lucide-react-native';
          ...
          {workspaces.map((workspace) => (
            <TouchableOpacity
              ...
              style={[
                ...
                workspace._id === activeWorkspace?._id && styles.activeWorkspace,
              ]}
            ...
            >
              <View style={styles.workspaceContent}>
                ...
                <View style={styles.workspaceInfo}>
                  ...
                  <Text style={styles.workspaceUrl}>{workspace.slug}.flowtask.com</Text>
                </View>
              </View>
