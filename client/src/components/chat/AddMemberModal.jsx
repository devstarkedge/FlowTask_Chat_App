  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: "9px 10px",
        borderRadius: 10,
        border: `1px solid ${hovered ? "var(--border-color)" : "transparent"}`,
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {isOnline && (
            <span
              style={{
                ...
                letterSpacing: ".05em",
                background:
                  "color-mix(in srgb, var(--status-online, #22c55e) 14%, transparent)",
                color: "var(--status-online, #22c55e)",
                border:
                  "1px solid color-mix(in srgb, var(--status-online, #22c55e) 22%, transparent)",
                flexShrink: 0,
              }}
            >
              Online
        ...
        >
          <Mail size={9} style={{ flexShrink: 0, opacity: 0.6 }} />
          {u.email}
        </p>
      </div>
        ...
        {wasAdded ? (
          <motion.div
            ...
            style={{
              ...
              background:
                "color-mix(in srgb, var(--success-color, #2eb67d) 12%, transparent)",
              border:
                "1px solid color-mix(in srgb, var(--success-color, #2eb67d) 24%, transparent)",
            }}
          >
            <UserCheck size={13} />
            Added
          ...
          <motion.button
            ...
            style={{
              ...
              fontSize: 12,
              fontWeight: 700,
              cursor: addingAny ? "not-allowed" : "pointer",
              flexShrink: 0,
              fontFamily: "inherit",
              background: isAdding
                ...
                : "var(--accent-color)",
              color: "#fff",
              opacity: addingAny && !isAdding ? 0.55 : 1,
              boxShadow: isAdding
                ? "none"
                : "0 2px 8px color-mix(in srgb, var(--accent-color) 32%, transparent)",
              transition:
                "background 140ms ease, opacity 140ms ease, box-shadow 140ms ease",
            }}
          >
            {isAdding ? (
              <Loader2
...
export default function AddMemberModal({ channel, onClose }) {
  ...
  const handleAdd = async (targetUser) => {
    ...
    try {
      await addMember(channel._id, userId);
      ...
      setTimeout(() => {
        setUsers((prev) =>
          prev.filter((u) => (u.chatUserId || u.flowTaskUserId) !== userId),
        );
        setAddedIds((prev) => {
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div
                  style={{
                    ...
                    boxShadow:
                      "0 2px 8px color-mix(in srgb, var(--accent-color) 14%, transparent)",
                    ...
                    {addedCount > 0 && (
                      <motion.span
                        ...
                        style={{
                          ...
                          letterSpacing: ".05em",
                          background:
                            "color-mix(in srgb, var(--success-color, #2eb67d) 14%, transparent)",
                          color: "var(--success-color, #2eb67d)",
                          border:
                            "1px solid color-mix(in srgb, var(--success-color, #2eb67d) 22%, transparent)",
                        }}
                      >
                        +{addedCount} added
                      </motion.span>
          ...
          <div style={{ padding: "14px 16px 10px", flexShrink: 0 }}>
            <div
              style={{
                ...
                border: `1.5px solid ${
                  searchFocused ? "var(--accent-color)" : "var(--border-color)"
                }`,
          ...
          >
            ...
            {!isLoading && users.length > 0 && (
              ...
              >
                ...
                {onlineCount > 0 && (
                  <span
                    style={{
                      ...
                      borderRadius: 999,
                      background:
                        "color-mix(in srgb, var(--status-online, #22c55e) 12%, transparent)",
                      color: "var(--status-online, #22c55e)",
                      border:
                        "1px solid color-mix(in srgb, var(--status-online, #22c55e) 20%, transparent)",
                    }}
                  >
                    {onlineCount} online
                  </span>
                ...
                />
                <span style={{ opacity: 0.6 }}>{users.length}</span>
              </motion.div>
            )}
