...
export default function SlackFileCard({
  ...
  const thumb =
    file.thumbnailUrl || file.secureUrl || file.url || file.preview || null;
  ...
  return (
    ...
    >
      ...
      <div className="slack-file-preview-info">
        <p className="slack-file-preview-name" title={name}>
          {name}
        </p>
        <div
          style={{
        ...
        >
          {size && (
            <span className="slack-file-preview-size">
              {formatFileSize(size)}
            </span>
          )}
          {file.uploadedBy?.name && (
            <span
              className="slack-file-preview-meta"
