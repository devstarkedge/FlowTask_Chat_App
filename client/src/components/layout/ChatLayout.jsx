  ...
  const handleResizeStart = useCallback(
    (e) => {
      ...
      const onMove = (ev) => {
        ...
        const newW = Math.min(
          SIDEBAR_MAX,
          Math.max(SIDEBAR_MIN, startW + delta),
        );
  ...
  return (
    <header className="app-topbar">
      ...
      <div className="app-topbar__actions">
        <button
          className="app-topbar__icon app-topbar__bell"
      ...
      <div className="text-center max-w-sm px-6">
        ...
        >
          <div className="flex items-center gap-1.5">
            <span style={{ color: "var(--status-online)", fontSize: 10 }}>
              ●
            </span>
            Real-time messaging
          </div>
        ...
        <div className="h-full flex flex-col">
          ...
          >
            ...
            >
              ...
              <ChevronRight size={14} style={{ color: "var(--text-muted)" }} />
              <span className="truncate" style={{ color: "var(--text-white)" }}>
                {fileName}
              </span>
            </div>
          ...
          <div className="flex-1 overflow-hidden p-4">
            ...
            >
              <div
                className="px-4 py-3 border-b border-current"
                style={{
                  color: "var(--text-secondary)",
              ...
              >
                ...
                {!isImage && !isVideo && !isAudio && (
                  <div
                    ...
                    style={{ color: "var(--text-muted)", gap: "10px" }}
                  >
