...
// Source: TaskChat: Channels Privacy Policy document.
// Synchronized with chat-mobile/src/data/privacyContent.js

export const PRIVACY_LAST_UPDATED = 'August 25, 2026';

export const PRIVACY_INTRO = [
  'Welcome to TaskChat: Channels. We respect your privacy and are committed to protecting the personal information you share with us.',
  'This Privacy Policy explains what information we collect, how we use it, who we share it with, and your choices regarding your information when you use the TaskChat: Channels application ("Service").',
];
...
export const PRIVACY_SECTIONS = [
  {
    ...
    blocks: [
      { type: 'p', text: 'We may collect the following types of information when you use TaskChat: Channels:' },
      { type: 'ul', items: [
        ...
        'Third-Party Integrations: Data from third-party services you connect to TaskChat: Channels.'
      ] },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'ul', items: [
        ...
        'For legal reasons: If required by law, subpoena, or to protect the safety and rights of TaskChat: Channels or its users.',
