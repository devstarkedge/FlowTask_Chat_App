...
export default function WorkspaceSelectorPage() {
  ...
  const { workspaces, isLoading, error, fetchWorkspaces, switchWorkspace } =
    useWorkspaceStore();
    ...
    return (
      <div className="wsp">
        <div className="wsp-center">
          ...
          <button className="wsp-retry-btn" onClick={fetchWorkspaces}>
            Retry
          </button>
        </div>
      </div>
        ...
        <nav className="wsp-nav">
          <div className="wsp-nav-inner">
            <Link to="/" className="wsp-logo">
              ...
              <span className="wsp-logo-name">TaskChat</span>
            </Link>
        ...
        <div className="wsp-content">
          ...
          >
            ...
            <motion.h1 variants={fadeUp} className="wsp-heading">
              {hasWorkspaces ? "Choose a workspace" : "Welcome to TaskChat"}
            </motion.h1>
                    ...
                    >
                      ...
                      <div className="wsp-info">
                        ...
                        <div className="wsp-meta">
                          {ws.role && (
                            <span
                              className={`wsp-role-chip ${ws.role === "owner" ? "owner" : "member"}`}
                            >
                              {ws.role === "owner" && (
                                <Crown
                                  size={9}
            ...
            {!hasWorkspaces && (
              ...
              >
                ...
                <p className="wsp-empty-desc">
                  Create your first workspace and invite your team, or join one
